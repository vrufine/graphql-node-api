...
export const userResolvers = {
  ...
  Mutation: {
    ...
    updateUser: compose(...authResolvers)((p, { input }, { db, authUser }: { db: DbConnection, authUser: AuthUser }, i: GraphQLResolveInfo) => {
      return db.sequelize.transaction((t: Transaction) => {
        return db
          .User
    ...
    updateUserPassword: compose(...authResolvers)((p, { input }, { db, authUser }: { db: DbConnection, authUser: AuthUser }, i: GraphQLResolveInfo) => {
      return db.sequelize.transaction((t: Transaction) => {
        return db
          .User
          .findById(authUser.id)
    ...
    deleteUser: compose(...authResolvers)((p, args, { db, authUser }: { db: DbConnection, authUser: AuthUser }, i: GraphQLResolveInfo) => {
      return db.sequelize.transaction((t: Transaction) => {
