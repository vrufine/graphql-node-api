  ...
  describe('Queries', () => {
    describe('application/json', () => {
      ...
      describe('users', () => {
        ...
        it('should paginate an array of Users', () => {
          let body = {
            query: `
      ...
      describe('currentUser', () => {
        ...
        it('should return the token owner', () => {
          let body = {
            query: `
              query {
                currentUser {
    ...
    describe('application/json', () => {
      ...
      describe('updateUser', () => {
        it('should update an existing User', () => {
          ...
          return chai.request(app)
            ...
            .then(res => {
              ...
              expect(updatedUser.photo).not.null;
        ...
        it('should block operation if token is invalid', () => {
          ...
          return chai.request(app)
            .post('/graphql')
            .set('authorization', `Bearer invalid.token.provided`)
            .set('content-type', 'application/json')
            .send(JSON.stringify(body))
            .then(res => {
        ...
        it('should block operation if token is not provided', () => {
          ...
          return chai.request(app)
            ...
            .then(res => {
              ...
              expect(res.body.errors[0].message).to.equal('Nenhum token foi fornecido!');
